...
import zhaowe.guncannon.servlet.PlantsServlet;
...
public class PlantsServletTest {
	...
	public void testGetPlants() throws ServletException, IOException {
		...
		PlantsServlet ps = new PlantsServlet();
...
//		resp.getWriter().flush();
	...
	public void testGetPlant() throws ServletException, IOException {
		...
		MockHttpRequest req = new MockHttpRequest("id", "0");
